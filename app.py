...
def getData (ticker, year, price):
	...
	response = requests.get('https://www.quandl.com/api/v3/datatables/WIKI/Prices.json?ticker=%s&date.gte=%s&date.lte=%s&qopts.columns=ticker,date,%s&api_key=apiKey=WQP6QhDExp5ISMtcpKBVPRVI8CaJQ5sV' %(ticker,datestart,dateend,price))
	return response
